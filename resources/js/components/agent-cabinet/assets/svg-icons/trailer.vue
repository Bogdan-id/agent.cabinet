<template>
<svg version="1.1" class="trailer" style="width: 55; height: 35" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
<style>
  .leasing-type-block svg.trailer path {
    fill: white;
    transition: fill 0.10s ease-in;
  }
  .leasing-type-block.active svg.trailer path {
    fill: #d24a43;
  }
  .leasing-type-block:hover svg.trailer path {
    fill: #d24a43;
  }
</style>