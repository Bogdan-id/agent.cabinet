<div style="color: black!important;">
  ...
  @if($leasingObjectType == 'Обладнання')
    ...
    <div style="padding-left: 15px;">- вартість фінансування</div>
  @endif
  @if($leasingClientType == "1")
  <p>Прошу приняти до уваги, що при оформлені договору фінансового лізингу з фізичною особою, 
    угода оформлюється нотаріально. Приблизна вартість нотаріальних витрат 1% від суми договору.
  </p>
  @endif
